...
$this->title = Yii::t('app', 'Osago requests');
$this->params['breadcrumbs'][] = $this->title;

$template = '{view}';

if(Yii::$app->user->can('/site/osago-delete')) {
    $template .= ' {delete}';
}
?>
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model) {
                    if ($action === 'delete') {
                        return \yii\helpers\Url::to(['site/osago-delete', 'id' => $model->id]);
                    }
                    if ($action === 'view') {
                        return \yii\helpers\Url::to(['site/osago-view', 'id' => $model->id]);
                    }
                }
            ],
        ],
