...
$this->title = Yii::t('app', 'Accident requests');
$this->params['breadcrumbs'][] = $this->title;
$template = '{view}';

if(Yii::$app->user->can('/site/accident-delete')) {
    $template .= ' {delete}';
}
?>
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model) {
                    if ($action === 'delete') {
                        return \yii\helpers\Url::to(['site/accident-delete', 'id' => $model->id]);
                    }
                    if ($action === 'view') {
                        return \yii\helpers\Url::to(['site/accident-view', 'id' => $model->id]);
                    }
                }
            ],
        ],
