...
class InsonlineService implements FondServiceInterface
{
    /**
    ...
    {
        $auto_info = InsonlineRequest::sendRequest(InsonlineRequest::URLS['get_auto_info'], $osago, [
    ...
    {
        $driver_info = InsonlineRequest::sendRequest(InsonlineRequest::URLS['driver_info_by_pinfl'], $osago, [
            'pinfl' => $pinfl,
    ...
    {
        $driver_info = InsonlineRequest::sendRequest(InsonlineRequest::URLS['driver_license_info_by_pinfl'], $osago, [
            'pinfl' => $pinfl,
            'passportSeries' => $insurer_passport_series,
            'passportNumber' => $insurer_passport_number,
        ], $throw_error, [], 'post');
    ...
    {
        $driver_info = InsonlineRequest::sendRequest(InsonlineRequest::URLS['driver_info_by_birthday_pass'], $osago, [
    ...
    {
        $result = InsonlineRequest::sendRequest(InsonlineRequest::URLS['calc'], $osago, [
            'vehicle' => $vehicle,
