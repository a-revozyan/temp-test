...
/**
 * TravelPurposeSearch represents the model behind the search form of `common\models\TravelPurpose`.
 */
class TravelPurposeSearch extends TravelPurpose
{
    /**
     * {@inheritdoc}
     */
