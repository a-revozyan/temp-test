...
class Accident extends \yii\db\ActiveRecord
{
            ...
            $request_body = [
                ...
                'insureds' => array_map(function ($osago_driver){
                    return [
                        ...
                        'birthday' => date('d.m.Y', $osago_driver->birthday),
    ...
    public function get_policy_from_partner($osago, $throw_error = false, $begin_date = null)
    {
        /** @var Osago $osago */
        ...
        if (empty($begin_date))
            $begin_date = $osago->begin_date;
        $accident->begin_date = $begin_date;
