...
class SendPolicyExpireWarningMessage1Controller extends Controller
{
    public function actionRun()
    {
        ...
        foreach ($day1_osagos as $osago) {
            ...
            Yii::$app->queue1->push(new SendWarningSmsJob([
                ...
                'code' => $code,
                'phone' => $osago['phone'],
                'message' => "Sug'urta Bozor. Polis OSAGO dlya ". $osago['autonumber'] ." istekaet. Prodlit' polis: $short_url",
            ]));
        }
