...
class UpdateAutocompForm extends Model
{
    public $id;
    ...
    {
        return [
            [['autobrand_name', 'automodel_name', 'name', 'price', 'id', 'status'], 'required'],
            [['autobrand_name', 'automodel_name', 'name'], 'string'],
            [['autobrand_name', 'automodel_name', 'name'], 'filter', 'filter' => 'trim'],
            [['production_year', 'price', 'id', 'status'], 'integer'],
            [['id'], 'exist', 'skipOnError' => true, 'targetClass' => Autocomp::className(), 'targetAttribute' => ['id' => 'id']],
    ...
    {
        $autocomp = Autocomp::findOne($this->id);
