...
class UpdateKaskoRiskForm extends Model
{
    public $id;
    public $amount;
    public $name_ru;
    ...
    {
        return [
            [['name_ru', 'name_uz', 'name_en', 'amount', 'show_desc', 'id'], 'required'],
            [['category_id'], 'integer'],
            ...
            [['id'], 'exist', 'skipOnError' => true, 'targetClass' => KaskoRisk::className(), 'targetAttribute' => ['id' => 'id']],
        ];
    }

    public function save()
    {
        $kaskorisk = KaskoRisk::findOne($this->id);
